...
[Authorize(Roles = "1")]
public class VwTopProductController : ControllerBase
{
    private readonly IVwTopProductService _service;

    public VwTopProductController(IVwTopProductService service)
    {
        _service = service;
    }
